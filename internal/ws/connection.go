...
// Connection represents a WebSocket connection for a specific game.
...
func (c *Connection) ReadPump() {
	...
	for {
		...
		// For now, we don't process incoming messages (moves are via REST)
		// Future: could handle move messages here
	}
}
